...
struct reserved_entry reserved_table[] = {
    ...
    { "b"       , TOK_MNEMONIC, opcode_table + MNEMONIC_B       },
    ...
    { "neg"     , TOK_MNEMONIC, opcode_table + MNEMONIC_NEG     },
    ...
    { "rol"     , TOK_MNEMONIC, opcode_table + MNEMONIC_ROL     },
    { "ror"     , TOK_MNEMONIC, opcode_table + MNEMONIC_ROR     },
    { "sb"      , TOK_MNEMONIC, opcode_table + MNEMONIC_SB      },
    { "sgt"     , TOK_MNEMONIC, opcode_table + MNEMONIC_SGT     },
    ...
    { "sne"     , TOK_MNEMONIC, opcode_table + MNEMONIC_SNE     },
